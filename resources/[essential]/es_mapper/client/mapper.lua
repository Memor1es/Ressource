...
Mapper.SaveObjects = function(name)
	...
	Citizen.CreateThread(function()
		...
		TriggerServerEvent('es_mapper:endSaveObjects', name)
...
Mapper.LoadObjects = function(name)
	...
	TriggerServerEvent('es_mapper:loadObjects', name)
end
...
RegisterNetEvent('es_mapper:loadObject')
AddEventHandler('es_mapper:loadObject', function(object)
	object.frozen = true
	Mapper.AddObject(MapperObject:unSerialize(object))
end)

RegisterNetEvent('es_mapper:showNotification')
AddEventHandler('es_mapper:showNotification', function(msg)
