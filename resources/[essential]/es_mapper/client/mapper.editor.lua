...
Editor.HandleSelectedObjectsThisFrame = function()
	...
	if IsControlPressed(0, Keys['LEFTCTRL']) then
		...
		if
			IsControlJustPressed(0, Keys['TOP'])  or
			IsControlJustPressed(0, Keys['DOWN']) or
			IsControlJustPressed(0, Keys['LEFT']) or
			IsControlJustPressed(0, Keys['RIGHT'])
		then
		...
		if
			...
			IsControlJustPressed(0, Keys['DOWN'])  or
			IsControlJustPressed(0, Keys['LEFT'])  or
			IsControlJustPressed(0, Keys['RIGHT']) or
			IsControlJustPressed(0, Keys['N+'])    or
			IsControlJustPressed(0, Keys['N-'])
		then
