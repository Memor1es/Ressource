...
ESX.StartDBSync = function()
	function saveData()
		ESX.SavePlayers()
		SetTimeout(5 * 60 * 1000, saveData) -- 10
	end
...
ESX.CreatePickup = function(type, name, count, label, player)
	...
	print(GetPlayerName(player) .. " à créer un objet au sol " .. label .. " " .. name)
...
ESX.DoesFactionExist = function(faction, grade2)
	grade2 = tostring(grade2)

	if faction and grade2 then
		if ESX.Factions[faction] and ESX.Factions[faction].grades[grade2] then
			return true
		end
	end
