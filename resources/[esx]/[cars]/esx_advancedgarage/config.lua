...
Config.PointMarker = {Type = 36, r = 255, g = 255, b = 255, x = 1.5, y = 1.5, z = 1.0} 	-- Green Color / voiture.
Config.DeleteMarker = {Type = 1, r = 255, g = 0, b = 0, x = 5.0, y = 5.0, z = 1.0} 	-- Red Color / Big Size Circle.
Config.PoundMarker = {Type = 36, r = 0, g = 0, b = 100, x = 1.5, y = 1.5, z = 1.0} 	-- Blue Color / voitu
Config.JPoundMarker = {Type = 36, r = 255, g = 255, b = 255, x = 1.5, y = 1.5, z = 1.0} 	-- Red Color / voitu

Config.GarageBlip = {Sprite = 290, Color = 38, Display = 2, Scale = 0.7} 		-- Public Garage Blip.
Config.PGarageBlip = {Sprite = 524, Color = 53, Display = 2, Scale = 0.7} 		-- Private Garage Blip.
Config.PoundBlip = {Sprite = 620, Color = 49, Display = 2, Scale = 0.8} 			-- Pound Blip.
Config.JGarageBlip = {Sprite = 290, Color = 0, Display = 2, Scale = 0.5}		-- Job Garage Blip.
Config.JPoundBlip = {Sprite = 620, Color = 0, Display = 2, Scale = 0.7} 		-- Job Pound Blip.

Config.PoundWait = 0.5 				-- How many Minutes someone must wait before Opening Pound Menu Again.
Config.JPoundWait = 0.5 			-- How many Minutes someone must wait before Opening Job Pound Menu Again.
...
Config.AmbulancePoundPrice = 100 	-- How much it Costs to get Vehicle from Ambulance Pound.
...
Config.PolicePoundPrice = 100 		-- How much it Costs to get Vehicle from Police Pound.

Config.UseAircraftGarages = true 	-- true = Allows use of Aircraft Garages.
Config.UseAircraftBlips = true	 	-- true = Use Aircraft Blips.
Config.AircraftPoundPrice = 1500 	-- How much it Costs to get Vehicle from Aircraft Pound.
...
Config.AmbulanceGarages = {
	Los_Santos = {
		Marker = vector3(320.933, -557.98, 28.74),
		Spawner = vector3(316.70, -547.84, 28.74),
		Spawner2 = vector3(326.37, -542.654, 28.743),
		Deleter = vector3(340.41, -561.98, 27.743),
		Deleter2 = vector3(290.232, -583.363, 42.155),
		Heading = 28.74,
		Heading2 = 179.495
	}
}
...
Config.PoliceGarages = {
	Los_Santos = {
		Marker = vector3(455.11, -1017.311, 28.30),
...
Config.CarGarages = {
	Los_Santos = {
		Marker = vector3(100.53, -1072.19, 29.23),
		Spawner = vector3(117.76, -1082.28, 29.5722),
		Deleter = vector3(136.04, -1048.66, 28.15),
		Heading = 157.84
	},
	Sandy_Shores = {
	...
	Hopital = {
		Marker = vector3(361.33, 298.84, 103.88),
		Spawner = vector3(370.79, 283.91, 103.25),
		Deleter = vector3(395.37, 289.11, 101.96),
		Heading = 247.47
	},
	Prison = {
		Marker = vector3(1846.56, 2585.86, 45.67),
		Spawner = vector3(1855.11, 2592.72, 44.67),
		Deleter = vector3(1855.21, 2615.3, 34.67),
		Heading = 274.8
	},
	Aeroport = {
		Marker = vector3(-977.216, -2710.379, 13.853),
		Spawner = vector3(-977.216, -2710.379, 13.853),
		Deleter = vector3(-966.8, -2709.9, 12.8),
		Heading = 346.05
	}
