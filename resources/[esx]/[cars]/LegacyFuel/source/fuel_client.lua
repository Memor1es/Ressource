...
if Config.EnableHUD then
	...
	Citizen.CreateThread(function()
		while true do
			...
			if displayHud then
				DrawAdvancedText(0.245 - x, 0.950 - y, 0.005, 0.0028, 0.6, kmh, 255, 255, 255, 255, 6, 1)
				DrawAdvancedText(0.220 - x, 0.959 - y, 0.005, 0.0028, 0.4, "km/h", 255, 255, 255, 255, 6, 1)
				DrawAdvancedText(0.208 - x, 0.802 - y, 0.005, 0.0028, 0.5, fuel, 255, 255, 255, 255, 6, 1)
				DrawAdvancedText(0.175 - x, 0.805 - y, 0.005, 0.0028, 0.4, "Essence:", 255, 255, 255, 255, 6, 1)
			else
				Citizen.Wait(750)
			end
		end
