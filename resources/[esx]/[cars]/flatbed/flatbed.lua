...
AddTextEntry(controllerMessageLoweredCar, "Appuyez sur ~INPUT_CONTEXT~ pour ~y~remonter ~w~le plateau.~n~Appuyez sur ~INPUT_DETONATE~ pour ~r~dettacher ~w~le vehicule.")
AddTextEntry(controllerMessageLoweredNoCar, "Appuyez sur ~INPUT_CONTEXT~ pour ~y~remonter ~w~le plateau.~n~Appuyez sur ~INPUT_DETONATE~ pour ~g~attacher ~w~le vehicule.")
AddTextEntry(controllerMessageRaised, "Appuyez sur ~INPUT_CONTEXT~ pour ~y~baisser ~w~le plateau.")
