...
function OpenShopMenu()
  ...
  table.insert(elements, {label = ('Magasin de vêtements <span style="color: green;">$</span>150'), value = 'shop_clothes'})
  table.insert(elements, {label = ('Changer tenue - garde robe'), value = 'player_dressing'})
  table.insert(elements, {label = ('<span style="color: red;">Supprimer tenue - garde robe</span>'), value = 'suppr_cloth'})
				...
				if data.current.value == 'yes' then
					...
					ESX.TriggerServerCallback('esx_eden_clotheshop:checkMoney', function(hasEnoughMoney)
						...
						if hasEnoughMoney then
							...
							ESX.ShowNotification('Vous avez acheté une nouvelle tenue')
							Citizen.Wait(100)
