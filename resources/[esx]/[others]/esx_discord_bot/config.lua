...
Config.webhook                = "https://discordapp.com/api/webhooks/721704210407882864/zICFIDO-kq4ujzb28A79paalNms9mm7UWv0eFqVxIBEp_BQvJG62-bEl4s3128ZhKHZk"


settings = {
	LogKills 			= true, 		-- Log when a player kill an other player.
	LogEnterPoliceVehicle 		= true, 		-- Log when a player enter in a police vehicle.
