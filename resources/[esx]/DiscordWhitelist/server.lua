...
--- Config ---
notWhitelistedMessage = "Vous n'êtes pas Whitelist passe la sur discord biloute :https://discord.gg/rzPAeFr " -- Message displayed when they are not whitelist with the role
