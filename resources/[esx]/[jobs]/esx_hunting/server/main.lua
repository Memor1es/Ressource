...
AddEventHandler('esx-qalle-hunting:sell', function()
    ...
    if MeatQuantity > 0 or LeatherQuantity > 0 then
        ...
        TriggerClientEvent('esx:showNotification', xPlayer.source, 'Tu vend ' .. LeatherQuantity + MeatQuantity .. ' tu recois $' .. LeatherPrice * LeatherQuantity + MeatPrice * MeatQuantity)
    else
