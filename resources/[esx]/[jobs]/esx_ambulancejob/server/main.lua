...
AddEventHandler('esx_ambulancejob:revive', function(target)
	...
	if societyAccount then
		if xPlayer.job.name == 'ambulance' then
			...
			TriggerClientEvent('esx:showNotification', xPlayer.source, 'Votre société a gagné ' .. Config.ReviveReward ..' ~g~$~s~', Config.ReviveReward)
...
if Config.EarlyRespawnFine then
	...
	AddEventHandler('esx_ambulancejob:payFine', function()
		...
		if societyAccount then
			if xPlayer.job.name == 'ambulance' then
				societyAccount.addMoney(fineAmount)
				TriggerClientEvent('esx:showNotification', xPlayer.source, 'Votre société a gagné ' .. Config.EarlyRespawnFineAmount ..' ~g~$~s~', Config.EarlyRespawnFineAmount)
				TriggerClientEvent('esx_ambulancejob:revive', target)
			end
		end
