...
Config.WeaponsInArmory = {
	...
	{ weaponHash = 'WEAPON_PISTOL_MK2', label = 'Pistolet MK2', type = 'pistol', attachment = true, 
		flashlight = 0x43FD595B, 
		suppressor = 0x21E34793,
		scope = 0x8ED4BB70 },

	{ weaponHash = 'weapon_carbinerifle_mk2', label = 'Carabine d\'Assaut MK2', type = 'rifle', attachment = true, 
		flashlight = 0x7BC4CDDC,
		suppressor = nil, 
		scope = 0xC66B6542 },

	{ weaponHash = 'weapon_heavysniper_mk2', label = 'Fusil de Sniper MK2', type = 'sniper', attachment = true, 
		flashlight = 0xEC0F617, 
		suppressor = 0x2E43DA41,
		scope = 0xBC54DA77 },

	{ weaponHash = 'weapon_assaultsmg', label = 'SMG d\'Assault', type = 'rifle', attachment = true, 
		flashlight = 0x7BC4CDDC, 
		suppressor = 0xBB46E417,	
		scope = 0x9D2FBF29 },

	{ weaponHash = 'weapon_bullpupshotgun', label = 'Carabine Bullpup', type = 'shotgun', attachment = true, 
		flashlight = 0x7BC4CDDC, 
		suppressor = 0xC164F53,
		scope = nil}
