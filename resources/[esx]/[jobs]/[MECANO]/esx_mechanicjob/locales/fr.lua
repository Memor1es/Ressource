Locales['fr'] = {
  ...
  ['quantity_invalid'] = 'Vous n\'avez pas assez de place ! ',
  ...
  ['veh_det_succ'] = 'Véhicule ~b~détattaché~s~ avec succès!',
  ...
  ['assembling_blowtorch'] = 'Assemblage des ~b~kits de crohetage~s~...',
