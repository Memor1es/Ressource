...
Config.NPCJobEarnings = { min = 10, max = 30 }
...
Config.Zones = {
	MechanicActions = {
		Pos = {x = -206.63, y = -1331.44, z = 33.89}, --vestiaire
		Size = {x = 1.2, y = 1.2, z = 1.0},
		Color = {r = 0, g = 255, b = 0},
		Type = 1
	},
	MechanicCloakroom = {
		Pos = {x = -206.79, y = -1341.71, z = 33.89}, --stock et action patron
		Size = {x = 1.2, y = 1.2, z = 1.0},
		Color = {r = 0, g = 255, b = 0},
		Type = 1
	},
	MechanicVehicles = {
		Pos = {x = -192.99, y = -1284.38, z = 30.27}, --vehicule de service
		Size = {x = 1.2, y = 1.2, z = 1.0},
		Color = {r = 0, g = 255, b = 0},
		Type = 1
	},
	Garage = {
		Pos = {x = 1498.216, y = -2130.03, z = 76.131}, --recuperation pour créer
		Size = {x = 1.2, y = 1.2, z = 1.0},
		Color = {r = 0, g = 255, b = 0},
		Type  = 1
	},
	Craft = {
		Pos = {x = -198.58, y = -1315.25, z = 30.09}, --creation kit
		Size = {x = 1.2, y = 1.2, z = 1.0},
		Color = {r = 0, g = 255, b = 0},
		Type = 1
	},
	VehicleSpawnPoint = {
		Pos = {x = -163.56, y = -1303.19, z = 30.74},
		Size = {x = 1.5, y = 1.5, z = 1.0},
		Type = -1
	},
	VehicleDeleter = {
		Pos = { x = -177.42, y = -1284.66, z = 30.30}, --ranger vehicule
