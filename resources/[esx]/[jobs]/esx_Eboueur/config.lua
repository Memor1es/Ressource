...
Config.Locale = 'en'   -- Traduções disponiveis: br/en.
Config.BagPay       = 25     -- Pague por sacola puxada do lixo.
Config.MulitplyBags = true   -- Multiplica BagPay pelo número de trabalhadores | 4 máximo.
