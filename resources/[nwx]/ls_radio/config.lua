...
Config.enableCmd = true
 --  /radio command should be active or not (if not you have to carry the item "radio") true / false

Config.messages = {

  ['not_on_radio'] = 'Vous êtes actuellement sur aucune fréquence',
  ['on_radio'] = 'Vous êtes actuellement sur la fréquence: <b>',
  ['joined_to_radio'] = 'Vous avez rejoint la fréquence: <b>',
  ['restricted_channel_error'] = 'Vous ne pouvez pas rejoindre les fréquences cryptées !',
