...
function UIMenuItem.New(Text, Description)
    local _UIMenuItem = {
        ...
        _Text = {
            Padding = { X = 8, },
            Colour = {
                Selected = { R = 0, G = 0, B = 0, A = 255 },  		--couleur du texte survolé
                Hovered = { R = 255, G = 255, B = 255, A = 255 },  	--couleur des autres textes
            }
        },
        ...
        Label = {
            ...
            MainColour = { R = 0, G = 0, B = 0, A = 255 }, --Rien
            HighlightColour = { R = 0, G = 0, B = 0, A = 255 }, --Rien
        },
        _Selected = false,
        _Hovered = false,
        _Enabled = true,
...
function UIMenuItem:RightLabel(Text, MainColour, HighlightColour)
    if MainColour ~= nil then
        ...
        labelMainColour = { R = 255, G = 255, B = 255, A = 255 } -- change rien ?
    end
    if HighlightColour ~= nil then
        labelHighlightColour = HighlightColour
    else
        labelHighlightColour = { R = 0, G = 0, B = 0, A = 255 } -- nada
    end
    if tostring(Text) and Text ~= nil then
        ...
        self.Label.MainColour = { R = 0, G = 0, B = 0, A = 0 } -- n a da
        self.Label.HighlightColour = { R = 0, G = 0, B = 0, A = 0 } --lol
