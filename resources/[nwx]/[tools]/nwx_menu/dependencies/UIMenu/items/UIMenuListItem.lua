...
-- Liste de proposition des menus droite gauche ; exemple " < Normal > "
...
function UIMenuListItem:Draw()
    ...
    if self:Enabled() then
        if self:Selected() then
            self.ItemText:Colour(0, 0, 0, 255) --texte entre < > survolé
            self.LeftArrow:Colour(0, 0, 0, 255) -- Couleur de la fleche < survolé
            self.RightArrow:Colour(0, 0, 0, 255) -- Couleur de la fleche > survolé
        else
            self.ItemText:Colour(245 ,245 ,245, 255) -- pareil sans survol
