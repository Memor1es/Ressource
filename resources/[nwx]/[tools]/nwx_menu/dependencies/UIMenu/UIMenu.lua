...
function UIMenu.New(Title, Subtitle, X, Y, TxtDictionary, TxtName, Heading, R, G, B, A)
    ...
    local _UIMenu = {
        ...
        Banner = 'holliday.png',
        Title = UIResText.New(Title, 215 + X, 20 + Y, 1.15, 10, 255, 255, 255, 1, 1, 0),
        BetterSize = false,
        Subtitle = { ExtraY = 0 },
        WidthOffset = 0,
        Position = { X = X, Y = Y },
    ...
    if Subtitle ~= "" and Subtitle ~= nil then
        _UIMenu.Subtitle.Rectangle = UIResRectangle.New(0 + _UIMenu.Position.X, 107 + _UIMenu.Position.Y, 431, 37, 252, 171, 34,255) --la barre titre du f5
        _UIMenu.Subtitle.Text = UIResText.New(Subtitle, 8 + _UIMenu.Position.X, 110 + _UIMenu.Position.Y, 0.35, 0, 0, 0, 255, 0) -- texte titre f5
        ...
        _UIMenu.PageCounter.Text = UIResText.New("", 425 + _UIMenu.Position.X, 110 + _UIMenu.Position.Y, 0.35, 0, 0, 0, 255, 0, "Right") -- 1/13 titre menu f5
