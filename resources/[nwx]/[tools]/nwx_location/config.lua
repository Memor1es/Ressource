...
Config.Zones = {
    BikeRental = {
        ...
        BlipSprite = 559, -- Map Marker Icon http://gtaxscripting.blogspot.com/2016/05/gta-v-blips-id-and-image.html
        BlipScale = 0.6, -- Size of Map Marker
        BlipColor =18, -- Map Marker Color
        ...
        Items = { -- Item, label, and price used for the menu
            ...
            {item = 'CRUISER', label = 'Cruiser', price = 20},
            {item = 'FIXTER', label = 'Fixter', price = 25},
            {item = 'SCORCHER', label = 'Mountainbike', price = 30},
            {item = 'TRIBIKE', label = 'Triathlon 1', price = 35},
            {item = 'TRIBIKE2', label = 'Triathlon 2', price = 40},
            {item = 'TRIBIKE3', label = 'Triathlon 3', price = 45},
        },
        Pos = { -- Zone positions
            --{x = -246.980, y = -339.820, z = 29.000},
            {x = -1010.77, y = -2740.44, z = 12.75},
            {x = -1262.36, y = -1438.98, z = 3.45},
            {x = -228.30, y = -1293.50, z = 30.30},
    ...
    --Basejumping = {
        ...
        --},
        --Items = { -- Item, label, and price used for the menu
            --{item = 'GADGET_PARACHUTE', label = 'Parachute', price = 30},
        --},
        --Pos = { -- Zone positions
